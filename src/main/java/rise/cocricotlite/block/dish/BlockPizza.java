...
import rise.cocricotlite.util.type.dish.EnumPizza;
import rise.cocricotlite.util.type.PropertyList;

public class BlockPizza extends BaseBlock {

    public BlockPizza()
    {
        super("pizza", Material.WOOD, Tabs.TAB_DISH, SoundType.WOOD, 0.5F, 1F);
        this.setBoundingBox(AABBList.AABB_CUBE_SMALL);
        this.setDefaultState(this.getBlockState().getBaseState().withProperty(PropertyList.PIZZA_TYPE, EnumPizza.MARGHERITA));
    ...
    {
        Helper.forItemModels(this, "dish", EnumPizza.class, EnumPizza.values().length);
    }
    ...
    {
        return new BlockStateContainer(this, PropertyList.PIZZA_TYPE);
    }
